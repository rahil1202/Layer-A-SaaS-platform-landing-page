    ...
    return (
        <section className="py-24 overflow-hidden">
            <div className="container">
                <div className="grid lg:grid-cols-2 items-center lg:gap-16 gap-8">
                    <div>
                        ...
                        <p className="text-white/50 mt-4 text-lg">
                            Layers seamlessly integrates with the tools you
                            already use, making it easy to incorporate into your
                            workflow.
                        </p>
                    </div>
                    <div>
                        <div className="h-[400px] lg:h-[700px] grid md:grid-cols-2 gap-4 mt-8 overflow-hidden [mask-image:linear-gradient(to_right,transparent, black_10%, black_90%, transparent)] ">
